package com.aier.mykotlindemo.module.navabout
...
import com.aier.mykotlindemo.utils.PackageUtil
...
class NavAboutActivity :BaseActivity(){
    ...
    fun onClick(view: View) {
        when (view.id) {
            R.id.tv_new_version ->{
                Utils.openLink(this, resources.getString(R.string.string_url_new_version))
            }
            R.id.tv_function -> {
